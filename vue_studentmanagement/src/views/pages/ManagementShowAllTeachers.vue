                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading p-3"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <router-link :to="{name: 'ManagementAddTeacher'}" href="#" class="btn btn-success float-right">Add New</router-link>
                                    </div>
                                    <div class="col-md-2">
                                            ...
                                            <tr v-for="item in teachers" :key="item.id">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <i class="btn btn-danger fas fa-trash-alt" v-on:click="deleteTeacher(item.id)"></i>
                                                    </div>
        ...
        components: {
         ...
         methods: {
            ...
            async deleteTeacher(id) {
                console.warn(id)
                await axios.delete("/management/delete_teacher_info/"+id);
