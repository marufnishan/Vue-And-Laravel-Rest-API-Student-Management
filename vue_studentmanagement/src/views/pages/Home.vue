<template>
    <div>
        ...
        <!-- Nav Section End -->
        <!-- Main Section Start -->
        <div class="container-fluid d-flex justify-content-center mt-5 pt-3 bg-light" id="cname">
            ...
            <div class="row">
                ...
                <div class="col-md-11">
                    <ul class="dynamic-txts">
                        ...
                        <li><span>Course Offer( Guidelines, Regi. Schedule & Semester Schedule of Spring-22
                                Second</span>
                        </li>
                        <li><span>Fees Payment Schedule for Spring-2022 semester's Registration Third</span></li>
